...
use mz_storage_types::sources::{
    ...
    LoadGeneratorSourceConnection, MySqlSourceConnection, MySqlSourceDetails,
    PostgresSourceConnection, PostgresSourcePublicationDetails, ProtoMySqlSourceDetails,
