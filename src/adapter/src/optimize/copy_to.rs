...
use crate::coord::peek::PeekDataflowPlan;
...
pub struct Optimizer {
    ...
    select_id: GlobalId,
    /// A transient GlobalId to be used when constructing a CopyToPlan.
    index_id: GlobalId,
    // Optimizer config.
...
impl<'s> Optimize<GlobalMirPlan<ResolvedGlobal<'s>>> for Optimizer {
    ...
    fn optimize(
        ...
        // XXX: add the sink export to the dataflow description
...
impl GlobalLirPlan {
    ...
    pub fn unapply(self) -> (PeekDataflowPlan, DataflowMetainfo) {
