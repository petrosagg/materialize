...
use mz_kafka_util::client::PartitionId;
use mz_storage_types::sources::{KinesisSourceConnection, MzOffset};
use mz_timely_util::order::Partitioned;

use super::types::SourceRender;

impl SourceRender for KinesisSourceConnection {
    type Key = Option<Vec<u8>>;
    type Value = Option<Vec<u8>>;
    type Time = Partitioned<PartitionId, MzOffset>;

    fn render<G: timely::dataflow::Scope<Timestamp = Self::Time>>(
        self,
        scope: &mut G,
        config: super::RawSourceCreationConfig,
        connection_context: mz_storage_types::connections::ConnectionContext,
        resume_uppers: impl futures::Stream<Item = timely::progress::Antichain<Self::Time>> + 'static,
        ...
        differential_dataflow::Collection<
            ...
            (
                usize,
                Result<
                    super::types::SourceMessage<Self::Key, Self::Value>,
                    super::types::SourceReaderError,
                >,
            ),
            mz_repr::Diff,
        >,
        Option<timely::dataflow::Stream<G, std::convert::Infallible>>,
        timely::dataflow::Stream<
            G,
            (
                crate::render::sources::OutputIndex,
                super::types::HealthStatusUpdate,
            ),
        >,
